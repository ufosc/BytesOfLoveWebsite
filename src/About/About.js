    ...
    return (
        <div className="about-page-container">
            ...
            <div className="credit-row">
                <a className="credit-cell" href="https://www.linkedin.com/in/tyra-pasion/" target="_blank">
                ...
                <a className="credit-cell" href="https://www.linkedin.com/in/ryder-keeny/" target="_blank">
                ...
                <a className="credit-cell" href="https://www.linkedin.com/in/gef5027/" target="_blank">
            ...
            <div className="credit-row">
                <a className="credit-cell" href="https://www.linkedin.com/in/wilson-goins/" target="_blank">
                ...
                <a className="credit-cell" href="https://www.linkedin.com/in/edward-roshko/" target="_blank">
                ...
                <a className="credit-cell" href="https://www.linkedin.com/in/sarah-tran1029/" target="_blank">
                ...
                <a className="credit-cell" href="https://www.linkedin.com/in/tikiri-ekanayake/" target="_blank">
            ...
            <div className="credit-row">
                <a className="credit-cell" href="https://www.linkedin.com/in/xael-font/" target="_blank">
                ...
                <a className="credit-cell" href="https://www.linkedin.com/in/antoncsalvador/" target="_blank">
                ...
                <a className="credit-cell" href="https://www.linkedin.com/in/jason-lin-66b906254/" target="_blank">
            ...
            <div className="credit-row">
                <a className="credit-cell" href="https://www.linkedin.com/in/jwmalegni/" target="_blank">
                ...
                <a className="credit-cell" href="https://www.linkedin.com/in/nicolasvaliente/" target="_blank">
            ...
            <div className="credit-row">
                <a className="credit-cell" href="https://www.linkedin.com/in/mathewalangadan/" target="_blank">
                    <img src="credits/Mathew.jpg" alt="Mathew Picture" />
                    <div className="credit-name">Mathew Alangadan</div>
                </a>

                <a className="credit-cell" href="https://www.linkedin.com/in/kanielv/" target="_blank">
                    <img src="credits/Kaniel.jpg" alt="Kaniel Picture" />
                    <div className="credit-name">Kaniel Vicencio</div>
                </a>

                <a className="credit-cell" href="https://www.linkedin.com/in/mohammedali0/" target="_blank">
                    <img src="credits/Mohammed.jpg" alt="Mohammed Picture" />
                    <div className="credit-name">Mohammed Ali</div>
                </a>
            </div>
            <div className="credit-row">
            <a className="credit-cell" href="https://www.linkedin.com/in/josephcabezas/" target="_blank">
                <img src="credits/Joey.jpg" alt="Joey Picture" />
                    <div className="credit-name">Joseph Cabezas</div>
                </a>

                <a className="credit-cell" href="https://www.linkedin.com/in/jonathanamesa/" target="_blank">
                    <img src="credits/Mesa.jpg" alt="Mesa Picture" />
                    <div className="credit-name">Jonathan Mesa</div>
                </a>

                <a className="credit-cell" href="https://www.linkedin.com/company/open-source-club/mycompany/" target="_blank">
            ...
            <div className="credit-row">
                <a className="credit-cell" href="https://dova-s.jp/bgm/play20356.html" target="_blank">
            ...
            <div className="thankyou-box">
                <div className="credit-name">Thank you to everyone who contributed to Bytes of Love, including those whose names may not have been mentioned. This is an open source visual novel so anyone is welcome to help! LGTM.</div>
            </div>
